...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://squid-app-nbdxg.ondigitalocean.app/";
	...
	<a href="https://squid-app-nbdxg.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
