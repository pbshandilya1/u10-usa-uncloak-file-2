...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            const redirectUrl = "https://walrus-app-5eysq.ondigitalocean.app/";
...
<a href="https://walrus-app-5eysq.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
</div>
            `;
